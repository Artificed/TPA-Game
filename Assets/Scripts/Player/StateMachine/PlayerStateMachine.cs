...
public class PlayerStateMachine : MonoBehaviour
{
    ...
    public void ShowDamageText(int damage, bool isCritical = false, bool isHeal = false)
    {
        ...
        damageText.transform.localScale = new Vector3(1, 1.5f, 1) / 10;
        ...
        if (isHeal)
        {
            textMesh.color = new Color(0f, .75f, 0f);
